...
class AgentCommunication:
    ...
    async def send_query(self, target_host_id: str, query: str, tools: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            async with aiohttp.ClientSession() as session:
                ...
                async with session.post(url, json=message.__dict__, timeout=30) as response:
